...
class LogAnalysisServiceTest {
    ...
    void analyzeChoosesLexicographicallySmallestOnCountTie() {
        ...
        LogAnalysisService service = new LogAnalysisService(repository, resultAssembler, new AnalysisResultDtoMapper());
    ...
    private LogRecord entry(String apiKey, String serviceId, String browser) {
        return new LogRecord(200, "http://apis.kokoa.com/search/" + serviceId + "?apikey=" + apiKey,
